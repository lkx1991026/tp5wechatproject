<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/notice\add.html";i:1506758595;s:76:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="main-title">
		<h2>
			<?php echo !empty($info['id'])?'编辑':'新增'; ?>小区通知
		</h2>
	</div>
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<div class="form-item">
			...
			<div class="controls">
				<!--<input type="hidden" class="text input-large" name="id" value="<?php echo (isset($info['id']) && ($info['id'] !== '')?$info['id']:''); ?>">-->
				<input type="file" id="upload_img" class="text input-large" name="image" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>"><br/>
				<img src="<?php echo $info['img_path']; ?>" style="height:100px;">
			</div>
		</div>
