<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/notice\index.html";i:1506760488;s:76:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="data-table table-striped">
		<table>
			...
			<tbody>
				<?php if(!(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty()))): if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<tr>
						<td><input class="ids row-selected" type="checkbox" name="id[]" id="" value="<?php echo $v['id']; ?>"> </td>
						<td><?php echo $v['title']; ?></td>
						<td><img src="<?php echo $v['img_path']; ?>" style="height:100px;"></td>
						<td><?php echo $v['create_time']; ?></td>
                        <td><?php echo $v['update_time']; ?></td>
                        <td><?php echo $v['author']; ?></td>
                        <td><?php echo !empty($v['status'])?'正常':'过期'; ?></td>
						<td>
							<a title="编辑" href="<?php echo url('add?id='.$v['id']); ?>">编辑</a>
							...
							<a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$v['id']); ?>">删除</a>
							<a class="confirm ajax-get" title="修改状态" href="<?php echo url('status?id='.$v['id']); ?>"><?php echo !empty($v['status'])?标记为过期:标记为正常; ?></a>
						</td>
					</tr>
