<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/repaire\index.html";i:1506740571;s:76:"D:\phpStudy\WWW\tt\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
			...
			<tbody>
				<?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<tr>
                        ...
                        <td><?php echo !empty($v['status'])?'已处理':'未处理'; ?></td>
						<td>
							<a title="编辑" href="<?php echo url('edit?id='.$v['id']); ?>">编辑</a>
							...
							<a class="confirm ajax-get" title="修改状态" href="<?php echo url('status?id='.$v['id']); ?>"><?php echo !empty($v['status'])?标记为未处理:标记为已处理; ?></a>
						</td>
					</tr>
