<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy\WWW\tt\public/../application/home/view/default/index\repaire.html";i:1506747360;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('admin/repaire/add'); ?>" method="post">
            ...
            <div class="form-group">
                <!--<label>您的电话(必填):</label>-->
                <input type="hidden" class="form-control" name="home" value="1"/>
            </div>
            <div class="form-group">
                <label>您的地址(必填):</label>
