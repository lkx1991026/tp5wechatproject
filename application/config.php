...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '/`T^n)"R#hA$@m]pdZQ8_lO6MK;U?wk5&:P2v<oX', //默认数据加密KEY
	'data_cache_key'=> '/`T^n)"R#hA$@m]pdZQ8_lO6MK;U?wk5&:P2v<oX',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'/`T^n)"R#hA$@m]pdZQ8_lO6MK;U?wk5&:P2v<oX', //加密KEY
